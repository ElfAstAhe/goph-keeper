...
### Что означает (опционально) в описании опций? Ваши credentials записываются в конфиг. Если эти опции не указаны, значит беруться из конфиг файла